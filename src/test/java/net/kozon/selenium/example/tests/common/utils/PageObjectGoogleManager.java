...
import net.kozon.selenium.example.tests.google.pages.LoginGooglePage;
import net.kozon.selenium.example.tests.google.pages.MainGooglePage;
import net.kozon.selenium.example.tests.google.pages.PasswordGooglePage;
