...
import net.kozon.selenium.example.tests.internet.pages.DragAndDropPage;
import net.kozon.selenium.example.tests.internet.pages.FileUploadPage;
import net.kozon.selenium.example.tests.internet.pages.MainPage;
